          ...
          <Row>
            ...
            <Col md="4">
              ...
              <img
                height={54.523}
                width={257.69}
                src={require("assets/img/CENTRO LOGO.png")}></img>
                <br/><br/><br/>
              <h2
                style={{
              ...
              {translate("presentation_header_text48")}
            </h2>
            <h2
            style={{
              fontFamily: "Domaine Display Condensed Medium",
                    ...
                    lineHeight: "0.3", /* 125% */
                    textTransform: "uppercase",
                  }}>  {translate("presentation_header_text49")}</h2>
                  <h2
            style={{
              fontFamily: "Domaine Display Condensed Medium",
              fontSize: "30px",
              ...
              textTransform: "uppercase",
                  ...
                  }}>{translate("presentation_header_text50")}</h2>
                   
          </Col>
         
            <img
           
              src={require("assets/img/HEADERC.png")}
            ></img>
