...
import BlogPostsHeaderGreen4 from "components/Headers/BlogPostsHeaderGreen4";
      ...
      <div className="wrapper">
        ...
        <div className="content-center">
          ...
          <Col md="4">
              <Container>
              <img 
                src={require("assets/img/1111.png")}
              ></img>
              </Container>
              </Col>
              <Col md="4">
              <Container>
              <img 
                src={require("assets/img/2222.png")}
              ></img>
              </Container>
              </Col>
              <Col md="4">
              <Container>
              <img
                    src={require("assets/img/33333.png")}
                  ></img>
                  </Container>
                  </Col>
          </Row>
