        ...
        style={{
             ...
             >
              ...
              <br/><br/>
                 ...
                 height={104.523}
                 width={240.69}
                    src={require("assets/img/LOGOBOKEH1.png")}></img>
            ...
            <br/><br/><br/><br/>
                  ...
                  style={{
                    ...
                    {translate("presentation_header_text34")}
                  </h2>
                  <h2
                   style={{
                    fontFamily: "Domaine Display Condensed Medium",
                  ...
                  >
                     {translate("presentation_header_text35")} </h2>
                  <h2
                  style={{
                    fontFamily: "Domaine Display Condensed Medium",
                    fontSize: "30px",
                    ...
                    textTransform: "uppercase",
                     ...
                     {translate("presentation_header_text36")}
                  </h2>
                ...
                <img
                    ...
                    src={require("assets/img/HEADERBOKEH.png")}
                  ></img>
